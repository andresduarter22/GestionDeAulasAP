    ...
    public function import($fileName, $idUploader, $tipoDeUpload)
    {
        ...
        foreach ($sheet->getRowIterator() as $row) {
            $_cadenaDeDatos = array(
                $sheet->getCellByColumnAndRow(1, $row->getRowIndex())->getValue(),
                $sheet->getCellByColumnAndRow(2, $row->getRowIndex())->getFormattedValue(),
                $sheet->getCellByColumnAndRow(3, $row->getRowIndex())->getFormattedValue(),
                $sheet->getCellByColumnAndRow(4, $row->getRowIndex()),
                $sheet->getCellByColumnAndRow(5, $row->getRowIndex()),
                $sheet->getCellByColumnAndRow(8, $row->getRowIndex())
            );
